...
IFontDisp = Font
__all__ = [ 'FontEvents', 'StdFont', 'FONTSTRIKETHROUGH', 'VgaColor',
           'IFontDisp', 'OLE_OPTEXCLUSIVE', 'IFont', 'OLE_HANDLE',
           'Font', 'OLE_XPOS_HIMETRIC', 'IPictureDisp', 'Monochrome',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_CONTAINER',
           'IFontEventsDisp', 'OLE_COLOR', 'Color',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_YPOS_CONTAINER',
           'OLE_YPOS_PIXELS', 'Picture', 'OLE_TRISTATE', 'IPicture',
           'Checked', 'FONTSIZE', 'StdPicture', 'OLE_XPOS_PIXELS',
           'OLE_XSIZE_PIXELS', 'FONTBOLD', 'Default', 'FONTITALIC',
           'OLE_CANCELBOOL', 'OLE_YSIZE_HIMETRIC', 'FONTUNDERSCORE',
           'Unchecked', 'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_CONTAINER',
           'OLE_YPOS_HIMETRIC', 'FONTNAME', 'OLE_YSIZE_PIXELS',
           'LoadPictureConstants', 'Gray']
from comtypes import _check_version; _check_version('', 1523489644.254465)
